...
use sc_client_api::{backend::{Backend as BackendT, StorageProvider}, client::BlockBackend, execution_extensions::ExecutionStrategies};
...
use sc_service::{
    ...
    config::{
        DatabaseConfig, PruningMode, TransactionPoolOptions,
...
pub fn client<T: Substrate, G, E, RA, EX>(db_config: DatabaseConfig, spec: PathBuf
            ...
            Arc<
                impl ChainAccess<NotSignedBlock<T>>
            >, 
        ServiceError>
where
